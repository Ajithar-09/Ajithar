            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              {experiences.map((exp, index) => (
                <ScrollReveal key={exp.id} threshold={0.1}>
                  <div className={`relative mb-16 last:mb-0 ${index % 2 === 0 ? "md:pr-12" : "md:pl-12 md:ml-auto"}`}>
                    {/* Timeline Dot */}
                    <motion.div
            ...
            <ScrollReveal>
              ...
              >
                ...
                <p className={`mb-6 max-w-2xl mx-auto ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
                  I'm always interested in challenging projects and opportunities to grow. If you think I'd be a good
                  fit for your team, let's connect!
                </p>
                <motion.a
                  href="/contact"
                  className={`inline-block px-8 py-3 rounded-full font-medium transition-all ${theme === "dark"
